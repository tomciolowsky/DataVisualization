...
TITLE_FONT_SIZE_MPL = 20
TITLE_FONT_SIZE_PLOTLY = 24
LABEL_FONT_SIZE = 14
TICK_FONT_SIZE = 12
SUNBURST_LABEL_FONT_SIZE = 18
SUNBURST_TEXT_FONT_SIZE = 14
...
for i, continent in enumerate(continents):
    ...
    buttons.append(dict(
        ...
        args=[{"visible": visibility},
              {"title.text": f"Number of fatalities in {continent}"}]
    ))
...
fig.update_layout(
    ...
    # width=1350,
    height=700,        
    font=dict(size=SUNBURST_TEXT_FONT_SIZE),
    font_family=TITLE_FONT_FAMILY,
    title_font_size=TITLE_FONT_SIZE_PLOTLY,
    title_font_color=TITLE_FONT_COLOR,
    title_font_weight=TITLE_FONT_WEIGHT,
...
fig.update_annotations(
    font_size=SUNBURST_LABEL_FONT_SIZE, 
