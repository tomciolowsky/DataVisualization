...
ax_map1.set_title("Total Political Violence Events", fontsize=15, fontweight="bold", pad=15)
...
ax_map2.set_title("Fatalities to Events Proportion", fontsize=15, fontweight="bold", pad=15)
...
ax_bar.set_title("Proportion of Disorder Types by Region", fontsize=15, fontweight="bold", pad=20)
...
A short description: In this section, we use choropleth maps to visualize the difference in the number of protests across the United States. We show both the number of protests in each state and the number of distinct events that took place during those protests.
...
A short description: Here, we use the sunburst charts to show the numbers of incidents and their hierarchy in the United States. We show the distribution of incidents across different disorder types, event types, and sub-event types.
...
A short description: In this part, we use a heatmap to visualize the number of distinct events that took place in 10 most affected states in the US. This plot allows us to see how the intensity changes over months.
